...
_C.MODEL.FCOS.FPN_STRIDES = [4, 8, 16, 32, 64]#[8, 16, 32, 64, 128]
...
# Discriminator
_C.SOLVER.DIS = CN()
_C.SOLVER.DIS.BASE_LR = 0.01 # 0.005
...
_C.SOLVER.MIDDLE_HEAD.BASE_LR = 0.01 #0.005
...
# detailed settings
_C.MODEL.MIDDLE_HEAD.GM.MATCHING_LOSS_CFG = 'L1' #d:'MSE'; 'BCE', 'L1'
_C.MODEL.MIDDLE_HEAD.GM.MATCHING_CFG = 'o2o'
_C.MODEL.MIDDLE_HEAD.GM.NODE_DIS_PLACE = 'feat' # 'intra', 'inter'
_C.MODEL.MIDDLE_HEAD.GM.WITH_QUADRATIC_MATCHING = False # d:F
_C.MODEL.MIDDLE_HEAD.GM.WITH_CLUSTER_UPDATE = False # F
_C.MODEL.MIDDLE_HEAD.GM.WITH_SEMANTIC_COMPLETION = True # F
_C.MODEL.MIDDLE_HEAD.GM.WITH_COMPLETE_GRAPH = True # d:F
_C.MODEL.MIDDLE_HEAD.GM.WITH_DOMAIN_INTERACTION = True # T
_C.MODEL.MIDDLE_HEAD.GM.WITH_COND_CLS = False # F
_C.MODEL.MIDDLE_HEAD.GM.WITH_CTR = False # F
_C.MODEL.MIDDLE_HEAD.GM.WITH_GLOBAL_GRAPH = False # F
_C.MODEL.MIDDLE_HEAD.GM.WITH_SCORE_WEIGHT = True # T
_C.MODEL.MIDDLE_HEAD.GM.WITH_NODE_DIS = False # F

# loss weight
_C.MODEL.MIDDLE_HEAD.GM.NODE_LOSS_WEIGHT = 0.1 # d:0.1
_C.MODEL.MIDDLE_HEAD.GM.MATCHING_LOSS_WEIGHT = 0.1 # d:0.1
_C.MODEL.MIDDLE_HEAD.GM.NODE_DIS_WEIGHT = 0.1
_C.MODEL.MIDDLE_HEAD.GM.NODE_DIS_LAMBDA = 0.01

# SIGMA++
_C.MODEL.MIDDLE_HEAD.GM.WITH_HyperGNN = False # F
