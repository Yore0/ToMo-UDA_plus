...
from adapteacher.modeling.GModule.graph_matching import build_graph_matching_head
...
class ATeacherTrainer(DefaultTrainer):
    def __init__(self, cfg):
        ...
        # Lvxg: Graph Matching for Topo & Morph
        graph_opt.MODEL.FCOS.NUM_CLASSES = cfg.MODEL.ROI_HEADS.NUM_CLASSES + 1
        self.graph_matching = build_graph_matching_head(graph_opt, 256).to(cfg.MODEL.DEVICE)
    ...
    def run_step_full_semisup(self):
        ...
        if self.iter < self.cfg.SEMISUPNET.BURN_UP_STEP:
            ...
            for key in record_dict.keys():
                ...
                # if self.iter < 100:
                #     loss_dict[key] = record_dict[key] * 0.01 #Lvxg: d:1
            losses = sum(loss_dict.values())
